...
* Репозиторий: [код здесь](https://rti30.github.io/task-crypto/)
...
### Планы
 ...
 Чтобы повысить востребованность, начинаю двигаться в двух направлениях:
1) Не совсем нравится, но: основы PHP + CMS (WordPress). Возможно, менее дорогой рынок сейчас нужнее .
2) Надежда умирает последней: React (Redux, Mobx), Typescript, MongoDB, GraphQL, Node.js, Тестирование, Nuxt, Next, Nest. Это все, что хотел изучать далее, но теперь буду изучать асинхронно.
